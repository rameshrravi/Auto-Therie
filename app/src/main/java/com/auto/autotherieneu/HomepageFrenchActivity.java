...
import com.auto.autotherieneu.ui.home.HomeGermanFragment;
...
import com.auto.autotherieneu.databinding.ActivityHomepageFrenchBinding;

public class HomepageFrenchActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_homepage_french);
        ...
        HomeFrenchFragment homeFragment=new HomeFrenchFragment();
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
         ...
         /*  HomeFragment homeFragment=new HomeFragment();
            ...
            {
                android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(HomepageFrenchActivity.this);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        if (id == R.id.nav_easy_car_theries) {
            Intent i=new Intent(getApplicationContext(),EasyCarTheoriesFrench.class);
            startActivity(i);
        }
        ...
        if (id == R.id.nav_exam) {
            Intent i=new Intent(getApplicationContext(),ExamsActivityFrench.class);
            startActivity(i);
        }
