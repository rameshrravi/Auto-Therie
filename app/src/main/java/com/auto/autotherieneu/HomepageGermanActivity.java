...
import com.auto.autotherieneu.databinding.ActivityHomepageGermanBinding;

public class HomepageGermanActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_homepage_german);
        ...
        HomeGermanFragment homeFragment=new HomeGermanFragment();
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
         ...
         /*  HomeFragment homeFragment=new HomeFragment();
            ...
            {
                android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(HomepageGermanActivity.this);
